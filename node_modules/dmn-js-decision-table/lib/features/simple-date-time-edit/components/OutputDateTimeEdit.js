...
var OutputDateEdit = /*#__PURE__*/function (_Component) {
  ...
  _createClass(OutputDateEdit, [{
    ...
    value: function render() {
      ...
      return createVNode(1, "div", "context-menu-container simple-date-edit", [createVNode(1, "h3", "dms-heading", createTextVNode("Edit date and time"), 2), createVNode(1, "h4", "dms-heading", createTextVNode("Set date and time"), 2), createVNode(1, "div", null, [createComponentVNode(2, ValidatedInput, {
        "onInput": this.onInput,
        "placeholder": "e.g. ".concat(getSampleDate()),
        "validate": validateISOString,
        "value": date,
        "className": "dms-block"
      }), createVNode(1, "p", "dms-hint", [createTextVNode("Use "), createVNode(1, "button", "use-today", createTextVNode("today"), 2, {
        "type": "button",
