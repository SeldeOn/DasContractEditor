...
var OutputTimeEdit = /*#__PURE__*/function (_Component) {
  _inherits(OutputTimeEdit, _Component);
  ...
  _createClass(OutputTimeEdit, [{
    ...
    value: function render() {
      ...
      return createVNode(1, "div", "context-menu-container simple-time-edit", [createVNode(1, "h3", "dms-heading", createTextVNode("Edit Date"), 2), createVNode(1, "h4", "dms-heading", createTextVNode("Set Date"), 2), createVNode(1, "div", null, [createComponentVNode(2, ValidatedInput, {
        "onInput": this.onInput,
        "placeholder": "e.g. ".concat(getSampleTime()),
        "validate": validateISOString,
        "value": date,
        "className": "dms-block"
      }), createVNode(1, "p", "dms-hint", [createTextVNode("Set date "), createVNode(1, "button", "use-now", createTextVNode("to now"), 2, {
        "type": "button",
...
export { OutputTimeEdit as default };
